...
if (isset($_POST['login-btn'])) {
    ...
    $sql = "SELECT * FROM client_login WHERE binary username = '$username' AND binary password = '$password'";
    ...
    if ($result->num_rows == 1) {
        ...
        $_SESSION['client_id'] = $row['client_id']; // Change this to 'username' if you want to store the username
